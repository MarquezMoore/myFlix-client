...
const ControlsBar = ({ movie, onBackClick }) => {
  return (
    <div className="d-flex w-100 justify-content-center pb-4 space-between">
      <Button className="me-auto bg-transparent border-0"  onClick={onBackClick}>
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-skip-backward-fill" viewBox="0 0 16 16">
      ...
      <Button className="bg-transparent border-0" onClick={ () => removeFromFavorites(movie)}>
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-trash2-fill" viewBox="0 0 16 16">
